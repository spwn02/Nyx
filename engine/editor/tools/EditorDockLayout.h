...
inline void BuildDefaultDockLayout(ImGuiID dockspaceId, const ImVec2 &size) {
  ...
  ImGui::DockBuilderDockWindow("Stats", ImGui::DockBuilderSplitNode(dockLeft, ImGuiDir_Down, 0.5f, nullptr, &dockLeft));
...
// static void BuildSceneEditingDockLayout(ImGuiID dockspaceId, const ImVec2 &size) {
//   ImGui::DockBuilderRemoveNode(dockspaceId);
//   ImGui::DockBuilderAddNode(dockspaceId, ImGuiDockNodeFlags_DockSpace);
//   ImGui::DockBuilderSetNodeSize(dockspaceId, size);
...
//   ImGui::DockBuilderDockWindow("Sky", dockRightDown);
//   ImGui::DockBuilderDockWindow("Asset Browser", dockBottomLeft);
//   ImGui::DockBuilderDockWindow("Material Graph", dockRight);

//   ImGui::DockBuilderFinish(dockspaceId);
// }

static void BuildMaterialEditingDockLayout(ImGuiID dockspaceId, const ImVec2 &size) {
  ImGui::DockBuilderRemoveNode(dockspaceId);
  ImGui::DockBuilderAddNode(dockspaceId, ImGuiDockNodeFlags_DockSpace);
  ImGui::DockBuilderSetNodeSize(dockspaceId, size);
  ...
  ImGuiID dockLeft = 0, dockRight = 0, dockBottom = 0, dockCenter = 0;
  ...
  dockRightBottom = ImGui::DockBuilderSplitNode(dockRight, ImGuiDir_Down, 0.4f, nullptr, &dockRight);

  // Dock windows
  ImGui::DockBuilderDockWindow("Viewport", dockCenter);
  ImGui::DockBuilderDockWindow("Material Graph", dockBottom);
  ImGui::DockBuilderDockWindow("Hierarchy", dockLeft);
  ImGui::DockBuilderDockWindow("Inspector", dockRight);
  ImGui::DockBuilderDockWindow("Asset Browser", ImGui::DockBuilderSplitNode(dockLeft, ImGuiDir_Down, 0.5f, nullptr, &dockLeft));
  ImGui::DockBuilderDockWindow("Sky", dockRightBottom);
  ImGui::DockBuilderDockWindow("Material Graph", dockBottomRight);
  ImGui::DockBuilderDockWindow("LUT Manager", dockRightBottom);

  ImGui::DockBuilderFinish(dockspaceId);
}

static void BuildPostProcessingEditingDockLayout(ImGuiID dockspaceId, const ImVec2 &size) {
  ImGui::DockBuilderRemoveNode(dockspaceId);
  ImGui::DockBuilderAddNode(dockspaceId, ImGuiDockNodeFlags_DockSpace);
  ImGui::DockBuilderSetNodeSize(dockspaceId, size);
  ...
  // Dock windows
  ImGui::DockBuilderDockWindow("Viewport", dockCenter);
  ImGui::DockBuilderDockWindow("Post Graph", dockBottom);
  ImGui::DockBuilderDockWindow("Hierarchy", dockLeft);
  ImGui::DockBuilderDockWindow("Inspector", dockRight);
  ImGui::DockBuilderDockWindow("Asset Browser", dockBottomLeft);
