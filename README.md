...
Adopting C++20 macros was one of the first and primary design choices for Nyx Engine. Each directory under `Engine/Source/Runtime/` represents an individual engine module, all of which follow strong compilation order.
...
---
## Dependencies
Nyx Engine vendors vcpkg, everything else is managed through it:
